...
- Conclusion : tout le monde a besoin d'une [**infrastructure *big data***]{.orange} ? 🤔
...
![Source : [nd.edu](https://www3.nd.edu/~pbui/teaching/cse.30331.fa16/challenge11.html)](img/mapreduce.png){fig-align="center" height="350" .fragment}
...
![Source : [min.io](https://min.io/)](img/minio.svg){height="300" fig-align="center" .fragment}
...
![Source : [datio.com](https://www.datio.com/iaas/understanding-the-data-partitioning-technique/)](img/partitions.png){fig-align="center" .fragment}
...
![Source : [Arrow](https://arrow.apache.org/overview/)](img/arrow-interoperability.png){fig-align="center" .fragment}
...
- Plaidoyer pour un [**découplage**]{.orange}...
    - ... qui [**facilite la mise en production**]{.blue2} !

## Les vertus du découplage {auto-animate=true}
